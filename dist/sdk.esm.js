...
var FACTORY_ADDRESSES = (_FACTORY_ADDRESSES = {}, _FACTORY_ADDRESSES[ChainId.MAINNET] = '0x0000000000000000000000000000000000000001', _FACTORY_ADDRESSES[ChainId.ROPSTEN] = '0x0000000000000000000000000000000000000001', _FACTORY_ADDRESSES[ChainId.RINKEBY] = '0x0000000000000000000000000000000000000001', _FACTORY_ADDRESSES[ChainId.GÖRLI] = '0x0000000000000000000000000000000000000001', _FACTORY_ADDRESSES[ChainId.KOVAN] = '0x0000000000000000000000000000000000000001', _FACTORY_ADDRESSES[ChainId.BSC_MAINNET] = '0xd3030bc02204477d6b453be95e9c3548089a214a', _FACTORY_ADDRESSES[ChainId.BSC_TESTNET] = '0xD6D546C6408CD06AC6e86f6e5d03dac41d2f3847', _FACTORY_ADDRESSES[ChainId.HARMONY_MAINNET] = '0x7D02c116b98d0965ba7B642ace0183ad8b8D2196', _FACTORY_ADDRESSES[ChainId.HARMONY_TESTNET] = '0x066bafafC84607a956967F6f050bD14A8347952F', _FACTORY_ADDRESSES);
...
var Route = /*#__PURE__*/function () {
  function Route(pairs, input, output) {
    ...
    !(input instanceof Token && pairs[0].involvesToken(input) || input && DEFAULT_CURRENCIES.includes(input) && pairs[0].involvesToken(WETH[pairs[0].chainId])) ? process.env.NODE_ENV !== "production" ? invariant(false, 'INPUT') : invariant(false) : void 0;
    !(typeof output === 'undefined' || output instanceof Token && pairs[pairs.length - 1].involvesToken(output) || output && DEFAULT_CURRENCIES.includes(output) && pairs[pairs.length - 1].involvesToken(WETH[pairs[0].chainId])) ? process.env.NODE_ENV !== "production" ? invariant(false, 'OUTPUT') : invariant(false) : void 0;
...
var Trade = /*#__PURE__*/function () {
  function Trade(route, amount, tradeType) {
    ...
    this.inputAmount = tradeType === TradeType.EXACT_INPUT ? amount : route.input && DEFAULT_CURRENCIES.includes(route.input) ? CurrencyAmount.ether(amounts[0].raw) : amounts[0];
    this.outputAmount = tradeType === TradeType.EXACT_OUTPUT ? amount : route.output && DEFAULT_CURRENCIES.includes(route.output) ? CurrencyAmount.ether(amounts[amounts.length - 1].raw) : amounts[amounts.length - 1];
