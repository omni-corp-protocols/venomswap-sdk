...
var IUniswapV2Pair = _interopDefault(require('@venomswap/core/build/IUniswapV2Pair.json'));
...
var FACTORY_ADDRESSES = (_FACTORY_ADDRESSES = {}, _FACTORY_ADDRESSES[exports.ChainId.MAINNET] = '0x0000000000000000000000000000000000000001', _FACTORY_ADDRESSES[exports.ChainId.ROPSTEN] = '0x0000000000000000000000000000000000000001', _FACTORY_ADDRESSES[exports.ChainId.RINKEBY] = '0x0000000000000000000000000000000000000001', _FACTORY_ADDRESSES[exports.ChainId.GÖRLI] = '0x0000000000000000000000000000000000000001', _FACTORY_ADDRESSES[exports.ChainId.KOVAN] = '0x0000000000000000000000000000000000000001', _FACTORY_ADDRESSES[exports.ChainId.BSC_MAINNET] = '0xd3030bc02204477d6b453be95e9c3548089a214a', _FACTORY_ADDRESSES[exports.ChainId.BSC_TESTNET] = '0xD6D546C6408CD06AC6e86f6e5d03dac41d2f3847', _FACTORY_ADDRESSES[exports.ChainId.HARMONY_MAINNET] = '0x7D02c116b98d0965ba7B642ace0183ad8b8D2196', _FACTORY_ADDRESSES[exports.ChainId.HARMONY_TESTNET] = '0x066bafafC84607a956967F6f050bD14A8347952F', _FACTORY_ADDRESSES);
var INIT_CODE_HASH = '0x7696f0158ae0f752dec0cc75187a9163e44686ae48c2e7d47bdd30df9b12f241';
...
Currency.BINANCE_COIN = /*#__PURE__*/new Currency(18, 'BNB', 'Binance Coin');
...
var Pair = /*#__PURE__*/function () {
  function Pair(tokenAmountA, tokenAmountB) {
    ...
    this.liquidityToken = new Token(tokenAmounts[0].token.chainId, Pair.getAddress(tokenAmounts[0].token, tokenAmounts[1].token), 18, 'VENOM-LP', 'Venom LP Token');
...
var Route = /*#__PURE__*/function () {
  function Route(pairs, input, output) {
    ...
    !(input instanceof Token && pairs[0].involvesToken(input) || input && DEFAULT_CURRENCIES.includes(input) && pairs[0].involvesToken(WETH[pairs[0].chainId])) ?  invariant(false, 'INPUT')  : void 0;
    !(typeof output === 'undefined' || output instanceof Token && pairs[pairs.length - 1].involvesToken(output) || output && DEFAULT_CURRENCIES.includes(output) && pairs[pairs.length - 1].involvesToken(WETH[pairs[0].chainId])) ?  invariant(false, 'OUTPUT')  : void 0;
...
var Trade = /*#__PURE__*/function () {
  function Trade(route, amount, tradeType) {
    ...
    this.inputAmount = tradeType === exports.TradeType.EXACT_INPUT ? amount : route.input && DEFAULT_CURRENCIES.includes(route.input) ? CurrencyAmount.ether(amounts[0].raw) : amounts[0];
    this.outputAmount = tradeType === exports.TradeType.EXACT_OUTPUT ? amount : route.output && DEFAULT_CURRENCIES.includes(route.output) ? CurrencyAmount.ether(amounts[amounts.length - 1].raw) : amounts[amounts.length - 1];
...
var Router = /*#__PURE__*/function () {
  ...
  Router.swapCallParameters = function swapCallParameters(trade, options) {
    var etherIn = trade.inputAmount.currency && DEFAULT_CURRENCIES.includes(trade.inputAmount.currency);
    var etherOut = trade.outputAmount.currency && DEFAULT_CURRENCIES.includes(trade.outputAmount.currency); // the router does not support both ether in and out
...
exports.JSBI = JSBI;
exports.BINANCE_COIN = BINANCE_COIN;
